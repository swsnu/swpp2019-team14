...
export const postUser = (user) => (dispatch) => axios.post('/api/user/', user).then((res) => {
  dispatch({
...
export const getSpecificUser = (id) => (dispatch) => axios.get(`/api/user/${id}/`).then((res) => dispatch({
  type: actionTypes.GET_SPECIFIC_USER,
  user: res.data,
}));
// export const GET_SEARCHED_USERS = 'GET_SEARCHED_USERS'
export const getSearchedUsers = (keyword) => (dispatch) => axios.get(`/api/user/searchWord=${keyword}/`).then((res) => dispatch({
  type: actionTypes.GET_SEARCHED_USERS,
  users: res.data,
}));

// export const GET_SEARCHED_BOOKS = 'GET_SEARCHED_BOOKS'
export const getSearchedBooks = (keyword, page) => (dispatch) => axios
  .get(`/api/book/${encodeURI(keyword)}/${page}/`)
  .then((res) => dispatch({
...
export const getSpecificBook = (isbn) => (dispatch) => axios.get(`/api/book/${isbn}/`).then((res) => dispatch({
  type: actionTypes.GET_SPECIFIC_BOOK,
  book: res.data,
}));

export const getArticles = (page) => (dispatch) => axios.get(`/api/article/page/${page}/`).then((res) => dispatch({
...
export const getSpecificArticle = (id) => (dispatch) => axios.get(`/api/article/${id}/`).then((res) => dispatch({
  type: actionTypes.GET_SPECIFIC_ARTICLE,
  article: res.data,
}));

// export const EDIT_SPECIFIC_ARTICLE = 'EDIT_SPECIFIC_ARTICLE'
export const editSpecificArticle = (article) => (dispatch) => axios.put(`/api/article/${article.id}/`, article).then((res) => dispatch({
  type: actionTypes.EDIT_SPECIFIC_ARTICLE,
  article: res.data,
}));
// export const DELETE_SPECIFIC_ARTICLE = 'DELETE_SPECIFIC_ARTICLE'
export const deleteSpecificArticle = (id) => (dispatch) => axios.delete(`/api/article/${id}/`).then((res) => dispatch({
  type: actionTypes.DELETE_SPECIFIC_ARTICLE,
}));
// export const GET_ARTICLE_LIKE = 'GET_ARTICLE_LIKE'
export const getArticleLike = (id) => (dispatch) => axios.get(`/api/article/${id}/`).then((res) => dispatch({
  type: actionTypes.GET_ARTICLE_LIKE,
  like: res.data,
}));
// export const POST_ARTICLE_LIKE = 'POST_ARTICLE_LIKE'
export const postArticleLike = (id) => (dispatch) => axios.post(`/api/article/${id}/like/`).then((res) => dispatch({
  type: actionTypes.POST_ARTICLE_LIKE,
  like: res.data,
}));
// export const DELETE_ARTICLE_LIKE = 'DELETE_ARTICLE_LIKE'
export const deleteArticleLike = (id) => (dispatch) => axios.delete(`/api/article/${id}/like/`).then((res) => dispatch({
  type: actionTypes.DELETE_ARTICLE_LIKE,
}));
// export const GET_ARTICLES_BY_BOOKID = 'GET_ARTICLES_BY_BOOKID'
export const getArticlesByBookId = (isbn) => (dispatch) => axios.get(`/api/article/bookID=${isbn}/`).then((res) => dispatch({
  type: actionTypes.GET_ARTICLES_BY_BOOKID,
  articles: res.data,
}));
// export const GET_ARTICLES_BY_USERID = 'GET_ARTICLES_BY_USERID'
export const getArticlesByUserId = (id) => (dispatch) => axios.get(`/api/article/userID=${id}/`).then((res) => dispatch({
...
export const postCuration = (curation) => (dispatch) => axios.post('/api/curation/', curation).then((res) => dispatch({
  type: actionTypes.POST_CURATION,
  curation: res.data,
}));

// export const GET_SPECIFIC_CURATION = 'GET_SPECIFIC_CURATION'
export const getSpecificCuration = (id) => (dispatch) => axios.get(`/api/curation/${id}/`).then((res) => dispatch({
  type: actionTypes.GET_SPECIFIC_CURATION,
  curation: res.data,
}));

// export const EDIT_SPECIFIC_CURATION = 'EDIT_SPECIFIC_CURATION'
export const editSpecificCuration = (curation) => (dispatch) => axios.put(`/api/curation/${curation.id}/`, curation).then((res) => dispatch({
  type: actionTypes.EDIT_SPECIFIC_CURATION,
  curation: res.data,
}));

// export const DELETE_SPECIFIC_CURATION = 'DELETE_SPECIFIC_CURATION'
export const deleteSpecificCuration = (id) => (dispatch) => axios.delete(`/api/curation/${id}/`).then((res) => dispatch({
  type: actionTypes.DELETE_SPECIFIC_CURATION,
}));

// export const GET_CURATION_LIKE = 'GET_CURATION_LIKE'
export const getCurationLike = (id) => (dispatch) => axios.get(`/api/curation/${id}/`).then((res) => dispatch({
  type: actionTypes.GET_CURATION_LIKE,
  like: res.data,
}));

// export const POST_CURATION_LIKE = 'POST_CURATION_LIKE'
export const postCurationLike = (id) => (dispatch) => axios.post(`/api/curation/${id}/like/`).then((res) => dispatch({
  type: actionTypes.POST_CURATION_LIKE,
  like: res.data,
}));
// export const DELETE_CURATION_LIKE = 'DELETE_CURATION_LIKE'
export const deleteCurationLike = (id) => (dispatch) => axios.delete(`/api/curation/${id}/like/`).then((res) => dispatch({
  type: actionTypes.DELETE_CURATION_LIKE,
}));
// export const GET_SEARCHED_CURATIONS = 'GET_SEARCHED_CURATIONS'
export const getSearchedCurations = (keyword) => (dispatch) => axios.get(`/api/curation/?searchWord=${keyword}/`).then((res) => dispatch({
  type: actionTypes.GET_SEARCHED_CURATIONS,
  curations: res.data,
}));
// export const GET_CURATIONS_BY_USERID = 'GET_CURATIONS_BY_USERID'
export const getCurationsByUserId = (id) => (dispatch) => axios.get(`/api/curation/?userID=${id}/`).then((res) => dispatch({
...
export const postLongReviewComment = (comment) => (dispatch) => axios.post('/api/comment/long_review/', comment).then((res) => dispatch({
  type: actionTypes.POST_LONG_REVIEW_COMMENT,
  comment: res.data,
}));
// export const GET_SPECIFIC_LONG_REVIEW_COMMENT = 'GET_SPECIFIC_LONG_REVIEW_COMMENT'
export const getSpecificLongReviewComment = (id) => (dispatch) => axios.get(`/api/comment/long_review/${id}/`).then((res) => dispatch({
...
export const editSpecificLongReviewComment = (comment) => (dispatch) => axios
  .put(`/api/comment/long_review/${comment.id}/`, comment)
  .then((res) => dispatch({
...
export const deleteSpecificLongReviewComment = (id) => (dispatch) => axios.delete(`/api/comment/long_review/${id}/`).then((res) => dispatch({
  type: actionTypes.DELETE_SPECIFIC_LONG_REVIEW_COMMNET,
}));
// export const GET_COMMENTS_BY_REVIEWID = 'GET_COMMENTS_BY_REVIEWID'
export const getCommentsByReviewID = (id) => (dispatch) => axios
  .get(`/api/comment/long_review/reviewID=${id}/`)
  .then((res) => dispatch({
...
export const postCurationComment = (comment) => (dispatch) => axios.post('/api/comment/curation/', comment).then((res) => dispatch({
  type: actionTypes.POST_CURATION_COMMENT,
  comment: res.data,
}));
// export const GET_SPECIFIC_CURATION_COMMENT = 'GET_SPECIFIC_CURATION_COMMENT'
export const getSpecificCurationComment = (id) => (dispatch) => axios.get(`/api/comment/curation/${id}/`).then((res) => dispatch({
  type: actionTypes.GET_SPECIFIC_CURATION_COMMENT,
  comment: res.data,
}));
// export const EDIT_SPECIFIC_CURATION_COMMENT  = 'EDIT_SPECIFIC_CURATION_COMMENT'
export const editSpecificCurationComment = (comment) => (dispatch) => axios
  .put(`/api/comment/curation/${comment.id}/`, comment)
  .then((res) => dispatch({
...
export const deleteSpecificCurationComment = (id) => (dispatch) => axios.delete(`/api/comment/curation/${id}/`).then((res) => dispatch({
  type: actionTypes.DELETE_SPECIFIC_CURATION_COMMNET,
}));
// export const GET_COMMENTS_BY_CURATIONID = 'GET_COMMENTS_BY_CURATIONID'
export const getCommentsByCurationID = (id) => (dispatch) => axios
  .get(`/api/comment/curation/?curationID=${id}/`)
  .then((res) => dispatch({
...
export const postLibrary = (library) => (dispatch) => axios.post('/api/library/', library).then((res) => dispatch({
  type: actionTypes.POST_LIBRARY,
  library: res.data,
}));
// export const GET_SPECIFIC_LIBRARY = 'GET_SPECIFIC_LIBRARY'
export const getSpecificLibrary = (id) => (dispatch) => axios.get(`/api/library/${id}/`).then((res) => dispatch({
  type: actionTypes.GET_SPECIFIC_LIBRARY,
  library: res.data,
}));
// export const EDIT_SPECIFIC_LIBRARY = 'EDIT_SPECIFIC_LIBRARY'
export const editSpecificLibrary = (library) => (dispatch) => axios.put(`/api/library/${library.id}/`, library).then((res) => dispatch({
  type: actionTypes.EDIT_SPECIFIC_LIBRARY,
  library: res.data,
}));
// export const DELETE_SPECIFIC_LIBRARY = 'DELETE_SPECIFIC_LIBRARY'
export const deleteSpecificLibrary = (id) => (dispatch) => axios.delete(`/api/library/${id}/`).then((res) => dispatch({
...
export const followUser = (userid) => (dispatch) => axios
...
export const unfollowUser = (userid) => (dispatch) => axios
...
export const getFollowers = (userid) => (dispatch) => axios.get(`/follow/?follower=${userid}/`).then((res) => dispatch({
  type: actionTypes.GET_FOLLOWERS,
  users: res.data,
}));
// export const GET_FOLLOWEES = 'GET_FOLLOWEES'
export const getFollowees = (userid) => (dispatch) => axios.get(`/follow/?followee=${userid}/`).then((res) => dispatch({
