...
export const logoutUser = () => {
  return dispatch => {
    return axios.post("/api/sign_out/").then(res =>
      dispatch({
...
export const getSearchedUsers = keyword => {
  return dispatch => {
    return axios.get("/api/user/searchWord=" + keyword + "/").then(res =>
      dispatch({
...
export const getSpecificBook = isbn => {
  return dispatch => {
    return axios.get("/api/book/" + isbn + "/").then(res =>
      dispatch({
...
export const getArticles = page => {
  return dispatch => {
    return axios.get("/api/article/page/" + page + "/").then(res =>
      dispatch({
...
export const editSpecificArticle = article => {
  return dispatch => {
    return axios.put("/api/article/" + article.id + "/", article).then(res =>
      dispatch({
...
export const postArticleLike = id => {
  return dispatch => {
    return axios.post("/api/article/" + id + "/like/").then(res =>
      dispatch({
...
export const deleteArticleLike = id => {
  return dispatch => {
    return axios.delete("/api/article/" + id + "/like/").then(res =>
      dispatch({
...
export const getArticlesByBookId = isbn => {
  return dispatch => {
    return axios.get("/api/article/bookID=" + isbn + "/").then(res =>
      dispatch({
...
export const getArticlesByUserId = id => {
  return dispatch => {
    return axios.get("/api/article/userID=" + id + "/").then(res =>
      dispatch({
...
export const postCuration = curation => {
  return dispatch => {
    return axios.post("/api/curation/", curation).then(res =>
      dispatch({
...
export const getSpecificCuration = id => {
  return dispatch => {
    return axios.get("/api/curation/" + id + "/").then(res =>
      dispatch({
...
export const editSpecificCuration = curation => {
  return dispatch => {
    return axios.put("/api/curation/" + curation.id + "/", curation).then(res =>
      dispatch({
...
export const deleteSpecificCuration = id => {
  return dispatch => {
    return axios.delete("/api/curation/" + id + "/").then(res =>
      dispatch({
...
export const postCurationLike = id => {
  return dispatch => {
    return axios.post("/api/curation/" + id + "/like/").then(res =>
      dispatch({
...
export const deleteCurationLike = id => {
  return dispatch => {
    return axios.delete("/api/curation/" + id + "/like/").then(res =>
      dispatch({
...
export const getSearchedCurations = keyword => {
  return dispatch => {
    return axios.get("/api/curation/?searchWord=" + keyword + "/").then(res =>
      dispatch({
...
export const getCurationsByUserId = id => {
  return dispatch => {
    return axios.get("/api/curation/?userID=" + id + "/").then(res =>
      dispatch({
...
export const postLongReviewComment = comment => {
  return dispatch => {
    return axios.post("/api/comment/long_review/", comment).then(res =>
      dispatch({
...
export const getSpecificLongReviewComment = id => {
  return dispatch => {
    return axios.get("/api/comment/long_review/" + id + "/").then(res =>
      dispatch({
...
export const deleteSpecificLongReviewComment = id => {
  return dispatch => {
    return axios.delete("/api/comment/long_review/" + id + "/").then(res =>
      dispatch({
...
export const postCurationComment = comment => {
  return dispatch => {
    return axios.post("/api/comment/curation/", comment).then(res =>
      dispatch({
...
export const getSpecificCurationComment = id => {
  return dispatch => {
    return axios.get("/api/comment/curation/" + id + "/").then(res =>
      dispatch({
...
export const deleteSpecificCurationComment = id => {
  return dispatch => {
    return axios.delete("/api/comment/curation/" + id + "/").then(res =>
      dispatch({
...
export const postLibrary = library => {
  return dispatch => {
    return axios.post("/api/library/", library).then(res =>
      dispatch({
...
export const getSpecificLibrary = id => {
  return dispatch => {
    return axios.get("/api/library/" + id + "/").then(res =>
      dispatch({
...
export const editSpecificLibrary = library => {
  return dispatch => {
    return axios.put("/api/library/" + library.id + "/", library).then(res =>
      dispatch({
...
export const deleteSpecificLibrary = id => {
  return dispatch => {
    return axios.delete("/api/library/" + id + "/").then(res =>
      dispatch({
...
export const getFollowers = userid => {
  return dispatch => {
    return axios.get("/follow/?follower=" + userid + "/").then(res =>
      dispatch({
...
export const getFollowees = userid => {
  return dispatch => {
    return axios.get("/follow/?followee=" + userid + "/").then(res =>
      dispatch({
